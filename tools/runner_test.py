...
def run_net_test_vote(args, config, train_writer=None, val_writer=None):
    ...
    if args.vote:
        metrics = validate_vote(base_model, test_dataloader, 0, val_writer, args, config, logger=logger)
